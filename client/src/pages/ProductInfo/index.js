...
import {GetProductById, GetProducts, GetAllBids} from '../../apicalls/products';
        ...
        <div>
            <div className="grid grid-cols-2 gap-5 mt-5">
                ...
                <div className="flex flex-col gap-5">
                    ...
                    <div className="flex gap-5">
                        {product.images.map((image, index) => {
                            return (
                                <img className={"w-20 h-20 object-cover rounded-md cursor-pointer " + (selectedImageIndex === index ? "border-2 border-dashed border-green-700 p-2" : "")}
                                     src={image}
                ...
                <div className="flex flex-col gap-3">
                    <div>
                        <h1 className="text-2xl font-semibold text-orange-900 mb-2">{product.name}</h1>
                    ...
                    <div className="flex flex-col">
                        <div className="flex justify-between mb-5">
                            ...
                            <Button onClick={() =>{setShowAddNewBid(!showAddNewBid)}}
                               disabled={user._id === product.seller._id ? true : false}
                            >New Bid</Button>
                        </div>
                        ...
                        {product.showBidsOnProductPage  && 
                          product.bids.map((bid) => {
                            return (
                                <div className="border border-gray-300 border-solid p-3 rounded mt-2">
            ...
            {showAddNewBid && <BidModal showBidModal={showAddNewBid} setShowBidModal={setShowAddNewBid} product={product} reloadData={getData}/>}
        </div>
  )
}
